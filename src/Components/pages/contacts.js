    ...
    render() {
        return (
            <div className="container-fluid">
                ...
                <p3>
                    <div className= "centerText"> Feel free to contact me anytime by email, on LinkedIn, or Glassdoor. You are also welcome to check out my Github to see some of the projects I worked on during college. <br /> </div>
