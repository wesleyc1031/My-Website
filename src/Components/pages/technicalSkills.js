            ...
            <div className="container-fluid">
                ...
                <p2>
                    ...
                    <u2>
                        ...
                        <li>Netbeans (4 years of experience)</li>
                        <li>Adobe Photoshop (4 years of experience)</li>
                        <li>Adobe Premiere Pro (4 years of experience)</li>
                        <li>Microsoft Office (4 years of experience)</li>
                        <li>XAMPP (4 years of experience)</li>
                        </u2>
                    </p4>
